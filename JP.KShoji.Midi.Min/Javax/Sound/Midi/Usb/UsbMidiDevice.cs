...
namespace JP.KShoji.Javax.Sound.Midi.Usb
{
	...
	public sealed class UsbMidiDevice : MidiDevice
	{
		...
		{
			return new MidiDevice.Info(usbDevice.DeviceName, string.Format("vendorId: %x, productId: %x"
				, usbDevice.VendorId, usbDevice.ProductId), "deviceId:" + usbDevice.DeviceId
