...
namespace JP.KShoji.Driver.Midi.Activity
{
		...
		, OnMidiDeviceAttachedListener, OnMidiInputEventListener
	{
		...
		internal Handler deviceDetachedHandler = null;
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			UsbManager usbManager = (UsbManager)GetApplicationContext().GetSystemService(Context
				.USB_SERVICE);
			...
			deviceDetachedListener = new AbstractMultipleMidiActivity.OnMidiDeviceDetachedListenerImpl
				(this);
			deviceDetachedHandler = new Handler(new _Callback_190(this));
			deviceConnectionWatcher = new MidiDeviceConnectionWatcher(GetApplicationContext()
				, usbManager, deviceAttachedListener, deviceDetachedListener);
		}

		private sealed class _Callback_190 : Handler.Callback
		{
			...
			public bool HandleMessage(Message msg)
			{
				...
				this._enclosing._enclosing.OnDeviceDetached(usbDevice);
				return true;
			}
