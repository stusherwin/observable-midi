...
public class MidiInputEventListener implements OnMidiInputEventListener {
	...
	@Override
	public void onMidiCableEvents(MidiInputDevice sender, int cable,
	...
	@Override
	public void onMidiSystemCommonMessage(MidiInputDevice sender,
	...
	@Override
	public void onMidiPolyphonicAftertouch(MidiInputDevice sender,
	...
	@Override
	public void onMidiSingleByte(MidiInputDevice sender, int cable,
			int byte1) {
		// TODO Auto-generated method stub
